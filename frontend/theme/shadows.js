...
export const customShadows = (mode) => {
  if (mode == "LIGHT_MODE") {
    return createCustomShadow(LIGHT_MODE);
  } else if (mode == "DARK_MODE") {
    return createCustomShadow(DARK_MODE);
  }
};

export const shadows = (mode) => {
  if (mode == "LIGHT_MODE") {
    return createShadow(LIGHT_MODE);
  } else if (mode == "DARK_MODE") {
    return createShadow(DARK_MODE);
  }
};
